...
export const skillsDescriptions: Record<SkillsKey, string> = {
  athletics: t("skills.descriptions.athletics"),
  brawl: t("skills.descriptions.brawl"),
  craft: t("skills.descriptions.craft"),
  drive: t("skills.descriptions.drive"),
  firearms: t("skills.descriptions.firearms"),
  melee: t("skills.descriptions.melee"),
  larceny: t("skills.descriptions.larceny"),
  stealth: t("skills.descriptions.stealth"),
  survival: t("skills.descriptions.survival"),

  academics: t("skills.descriptions.academics"),
  awareness: t("skills.descriptions.awareness"),
  finance: t("skills.descriptions.finance"),
  investigation: t("skills.descriptions.investigation"),
  medicine: t("skills.descriptions.medicine"),
  occult: t("skills.descriptions.occult"),
  politics: t("skills.descriptions.politics"),
  science: t("skills.descriptions.science"),
  technology: t("skills.descriptions.technology"),

  "animal ken": t("skills.descriptions.animalKen"),
  etiquette: t("skills.descriptions.etiquette"),
  insight: t("skills.descriptions.insight"),
  intimidation: t("skills.descriptions.intimidation"),
  leadership: t("skills.descriptions.leadership"),
  performance: t("skills.descriptions.performance"),
  persuasion: t("skills.descriptions.persuasion"),
  streetwise: t("skills.descriptions.streetwise"),
  subterfuge: t("skills.descriptions.subterfuge"),
}
